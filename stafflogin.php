          ...
          <div class="card horizontal">
            <div class="card-stacked">
              <div class="card-content">
                <form class="col s12" action="stafflogin.php" method="post">
                  ...
                  <div class="input-field col s12">
                    ...
                    <input id="password" type="password" name="passwo" class="validate" />
                ...
                <a href="staffprofile.php"><p class="flow-text center-align">Register</p></a>
                </form>
              </div>
            </div>
          </div>
