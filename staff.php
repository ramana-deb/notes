  ...
  <div class="row">
    <div class="col s12 m4 l3">
      <ul id="slide-out" class="sidenav sidenav-fixed collapsible">
        ...
        <li>
          <div class="collapsible-header black-text">
            <a href="stassign.php">Assignment</a>
          </div>
          <div class="collapsible-header black-text">
            <a href="#">My Account</a>
          </div>
    ...
    <div class="col s12 m10 offset-m1 l9">
      ...
      <table class="striped highlight centered">
        ...
        <tbody>
          <?php
          $query = "SELECT id,file_name,descrip,uploaded_by,status,files FROM uassign WHERE uploaded_to='$name' AND (dept = '$Dept')  ";
          if (isset($_POST['submit'])) {

            if (($_POST['filter1'] != " ") && ($_POST['filter'] != " ")) {
              $res1 = $_POST['filter1'];
              $res = $_POST['filter'];
              $query = "SELECT id,file_name,descrip,uploaded_by,status,files FROM uassign WHERE uploaded_to='$name' AND (dept = '$Dept')  AND (year ='$res') AND (sem ='$res1')";
            } else if ($_POST['filter'] != " ") {
              $res = $_POST['filter'];
              $query = "SELECT id,file_name,descrip,uploaded_by,status,files FROM uassign WHERE uploaded_to='$name' AND (dept = '$Dept')  AND (year ='$res') ";
            } else if ($_POST['filter1'] != " ") {
              $res1 = $_POST['filter1'];
              $query = "SELECT id,file_name,descrip,uploaded_by,status,files FROM uassign WHERE uploaded_to='$name' AND (dept = '$Dept') AND (sem ='$res1')";
          ...
          if (mysqli_num_rows($run_query) > 0) {
            ...
            while ($row = mysqli_fetch_array($run_query)) {
              ...
              <tr>
                ...
                <td><a href='uploadAssign/<?php echo $files; ?>'><i class='material-icons'>visibility</i></a></td>
                <td>
