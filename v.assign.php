          ...
          <li>
            ...
            <div class="collapsible-body">
              <span>
                ...
                <div class="collapsible-header">
                  <a href="uassign.php">Upload Notes</a>
                </div>
              </span>
            </div>
          </li>
        ...
        <div class="card horizontal">
          <div class="card-stacked">
            <div class="card-content">
              <h3>MY ASSIGNMENT</h3>
              <a href="uassign.php" class="waves-effect waves-light btn " style=" background-image: linear-gradient(to right, lightblue, darkblue)"
                ><i class="material-icons left ">add</i>Assignment</a
              >
              <br /><br />
              <table class="striped highlight centered ">
                ...
                <?php
                  $sql="SELECT id,file_name,descrip,uploaded_by,status,files FROM uassign where uploaded_by ='$name'";
...
?>                    
                      ...
                      <tr>
                        ...
                        <td><form action="uassigndelete.php" method="get"></form><a href='uassigndelete.php?id=<?php echo $Userid; ?>'><i class='material-icons'>delete</i></a></td>
                      </tr>
